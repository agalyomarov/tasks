                        ...
                        <div class="col-md-6">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Создание тактик </h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form method="post" action="{{ route('tacticStore') }}">
                                    @csrf
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Название такстики</label>
                                            <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Название цели" name="title">
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="card-footer">
                                        <button type="submit" class="btn btn-primary">Создать тактику</button>
                                    </div>
                            </div>
                            <!-- /.card-body -->
