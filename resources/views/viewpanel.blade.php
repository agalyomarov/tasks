                                ...
                                @foreach ($records as $record)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <br />
                                            <small>
                                                Дата создания {{ Date::parse($record->created_at)->format('d-m-Y') }}
                                            </small>
                                        </td>
                                        <td>
                                        ...
                                        <td class="project-actions text-right">
                                            <form action="{{ route('viewpanelTake') }}" method="post">
                                                ...
                                                <input class="btn btn-primary btn-sm" type="submit" value="Принят">
                                            </form>
                                            <form action="{{ route('viewpanelOffer') }}" method="post">
                                                ...
                                                <input type="hidden" value="{{ $record->name }}" name="name">
                                                <input type="hidden" value="{{ $record->id }}" name="id">
                                                <input class="btn btn-info btn-sm" type="submit" value="Отклонить">
                                            </form>
                                        </td>
                                    </tr>
                                @endforeach
